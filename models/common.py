...
class DetectMultiBackend(nn.Module):
    ...
    def forward(self, im, h=None, augment=False, visualize=False):
        ...
        if self.pt:  # PyTorch
            y = self.model(im, h, augment=augment, visualize=visualize) if augment or visualize else self.model(im)
